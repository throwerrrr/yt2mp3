...
class FileHandler:
    def __init__(self, link, dir, artist=None, song=None, genre=None, subdir=None, filename=None, song_mode=True):
    ...
    def get_song_mode_attr(self, song, artist, genre):
        ...
        self.filename = self.filename = self.sanitize_text(f"{self.artist}_{self.song}")
